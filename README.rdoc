...
This is app was developed by myself and {Jamie Panaia}[https://github.com/jpanaia]
...
If you would like to clone this repo, note that there is Faker data provided in the Seeds file. Running <tt>rake db:seed</tt> will populate the db with 5 users who (whom?) have 3 tweets each. Faker doesn't seem to have a Tweet and/or hashtag generator yet, so those 15 tweets are simply 140 random characters (no spaces, even). So to test out the hashtag functionality, you'll have to do that in your own tweets #sorrynotsorry
